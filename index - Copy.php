...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Mohammed Alshmayri ePortfolio</title>
...
<body class="host_version"> 
	...
	<div id="carouselExampleControls" class="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Mohammed</strong> Alshmayri</h2>
										<p class="lead">Software Engineer and IT Manager </p>
			...
			<div class="carousel-item">
				<div id="home" class="first-section" style="background-image:url('images/slider-06.jpg');">
					<div class="dtab">
						<div class="container">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									<div class="big-tagline">
										...
										<p class="lead" data-animation="animated fadeInLeft"> passionate about quality and professional development.</p>
											<a href="contact.php" class="hover-btn-new"><span>Contact Me</span></a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="resume.php" class="hover-btn-new"><span>Resume</span></a>
									</div>
